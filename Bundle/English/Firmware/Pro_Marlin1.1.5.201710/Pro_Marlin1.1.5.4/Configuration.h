...
#define CUSTOM_MACHINE_NAME "BIQU Pro"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 310 // get this value from auto calibrate
 ...
 */
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.85  // Increase this if the first layer is too thin (remember: it's a negative number so increase means closer to zero).
