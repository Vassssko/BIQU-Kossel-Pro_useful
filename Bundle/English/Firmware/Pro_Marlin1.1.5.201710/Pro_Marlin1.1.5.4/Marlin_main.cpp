...
inline void gcode_G4() {
  ...
  inline bool home_delta() {
    ...
    current_position[X_AXIS] = current_position[Y_AXIS] = current_position[Z_AXIS] = (DELTA_HEIGHT + home_offset[Z_AXIS] + 400);
...
inline void gcode_M502() {
  ...
  inline void gcode_M851() {
    ...
    if (parser.seen('Z')) {
      ...
      SERIAL_ECHOPAIR(": ", zprobe_baby_stepping);
